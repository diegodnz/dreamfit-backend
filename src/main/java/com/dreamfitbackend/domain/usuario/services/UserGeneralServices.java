	...
	public StatusMessage sendPasswordToken(String email) {       	
		...
		if (user != null) {					
			try {
	            ...
	            helper.setText(String.format("<h>Use este link para recuperar sua senha: <a href=%s>Clique aqui</a></h>", "https://dream-fit.vercel.app/users/recovery-token/" + token), true);
